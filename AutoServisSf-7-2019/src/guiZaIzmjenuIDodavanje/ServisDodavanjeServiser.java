...
public class ServisDodavanjeServiser extends JFrame{
	...
	public ServisDodavanjeServiser(PoslovnaLogika poslovnaLogka, Servis servis, Korisnik korisnik) {
		this.poslovnaLogika = poslovnaLogka;
		this.servis = servis;
		this.korisnik = korisnik;
		if(this.servis == null) {
			setTitle("Dodavanje novog servisa");
		}else {
			setTitle("Izmjena servisa: " + this.servis.getId());
		}
		...
		btnOK.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(validacija() == true) {
					...
					ServisDodavanjeServiser.this.dispose();
					ServisDodavanjeServiser.this.setVisible(false);
