...
//		Servis s = new Servis(1,a, serviser, new Date(), "oo", pl.getListaServisniDio(), Status.SLOBODAN);
//		
...
//		pl.procitajIzFajlaServiser();
//		
		AdministratorDodavanje ad = new AdministratorDodavanje(pl, null);
//		ad.setVisible(true);
...
//		AutomobilProzor ap = new AutomobilProzor(pl);
//		ap.setVisible(true);
